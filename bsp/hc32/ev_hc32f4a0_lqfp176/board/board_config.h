...
/*********** TIMA_PULSE_ENCODER configure *********/
            ...
            #define PULSE_ENCODER_TIMA_2_A_PORT      (GPIO_PORT_D)
            #define PULSE_ENCODER_TIMA_2_A_PIN       (GPIO_PIN_09)
            #define PULSE_ENCODER_TIMA_2_A_PIN_FUNC  (GPIO_FUNC_4)
            #define PULSE_ENCODER_TIMA_2_B_PORT      (GPIO_PORT_D)
            #define PULSE_ENCODER_TIMA_2_B_PIN       (GPIO_PIN_10)
            ...
            #define PULSE_ENCODER_TIMA_3_A_PORT      (GPIO_PORT_C)
            #define PULSE_ENCODER_TIMA_3_A_PIN       (GPIO_PIN_06)
            #define PULSE_ENCODER_TIMA_3_A_PIN_FUNC  (GPIO_FUNC_4)
            #define PULSE_ENCODER_TIMA_3_B_PORT      (GPIO_PORT_C)
            #define PULSE_ENCODER_TIMA_3_B_PIN       (GPIO_PIN_07)
            ...
            #define PULSE_ENCODER_TIMA_4_A_PORT      (GPIO_PORT_D)
            #define PULSE_ENCODER_TIMA_4_A_PIN       (GPIO_PIN_12)
            #define PULSE_ENCODER_TIMA_4_A_PIN_FUNC  (GPIO_FUNC_4)
            #define PULSE_ENCODER_TIMA_4_B_PORT      (GPIO_PORT_D)
            #define PULSE_ENCODER_TIMA_4_B_PIN       (GPIO_PIN_13)
            ...
            #define PULSE_ENCODER_TIMA_10_A_PORT      (GPIO_PORT_F)
            #define PULSE_ENCODER_TIMA_10_A_PIN       (GPIO_PIN_06)
            #define PULSE_ENCODER_TIMA_10_A_PIN_FUNC  (GPIO_FUNC_4)
            #define PULSE_ENCODER_TIMA_10_B_PORT      (GPIO_PORT_F)
            #define PULSE_ENCODER_TIMA_10_B_PIN       (GPIO_PIN_07)
            #define PULSE_ENCODER_TIMA_10_B_PIN_FUNC  (GPIO_FUNC_4)
            ...
            #define PULSE_ENCODER_TIMA_11_A_PIN_FUNC  (GPIO_FUNC_5)
            #define PULSE_ENCODER_TIMA_11_B_PORT      (GPIO_PORT_F)
            #define PULSE_ENCODER_TIMA_11_B_PIN       (GPIO_PIN_01)
            #define PULSE_ENCODER_TIMA_11_B_PIN_FUNC  (GPIO_FUNC_5)
            ...
            #define PULSE_ENCODER_TIMA_12_A_PIN_FUNC  (GPIO_FUNC_5)
            #define PULSE_ENCODER_TIMA_12_B_PORT      (GPIO_PORT_D)
            #define PULSE_ENCODER_TIMA_12_B_PIN       (GPIO_PIN_02)
            #define PULSE_ENCODER_TIMA_12_B_PIN_FUNC  (GPIO_FUNC_5)
            ...
            #define PULSE_ENCODER_TIM6_5_A_PIN       (GPIO_PIN_10)
            #define PULSE_ENCODER_TIM6_5_A_PIN_FUNC  (GPIO_FUNC_3)
            #define PULSE_ENCODER_TIM6_5_B_PORT      (GPIO_PORT_D)
            #define PULSE_ENCODER_TIM6_5_B_PIN       (GPIO_PIN_00)
