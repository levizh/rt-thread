...
#if defined(BSP_USING_TIM0_1A)
#define BSP_USING_TIM0_1A_IRQ_NUM       INT050_IRQn
#define BSP_USING_TIM0_1A_IRQ_PRIO      DDL_IRQ_PRIO_DEFAULT
#endif/* BSP_USING_TIM0_1A */
#if defined(BSP_USING_TIM0_1B)
#define BSP_USING_TIM0_1B_IRQ_NUM       INT051_IRQn
#define BSP_USING_TIM0_1B_IRQ_PRIO      DDL_IRQ_PRIO_DEFAULT
#endif/* BSP_USING_TIM0_1B */
#if defined(BSP_USING_TIM0_2A)
#define BSP_USING_TIM0_2A_IRQ_NUM       INT052_IRQn
#define BSP_USING_TIM0_2A_IRQ_PRIO      DDL_IRQ_PRIO_DEFAULT
#endif/* BSP_USING_TIM0_2A */
#if defined(BSP_USING_TIM0_2B)
#define BSP_USING_TIM0_2B_IRQ_NUM       INT053_IRQn
#define BSP_USING_TIM0_2B_IRQ_PRIO      DDL_IRQ_PRIO_DEFAULT
