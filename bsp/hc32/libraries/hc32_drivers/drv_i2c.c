...
#if defined (BSP_I2C1_TX_USING_DMA) || defined (BSP_I2C2_TX_USING_DMA) || defined (BSP_I2C3_TX_USING_DMA) ||    \
    defined (BSP_I2C4_TX_USING_DMA) || defined (BSP_I2C5_TX_USING_DMA) || defined (BSP_I2C6_TX_USING_DMA)
