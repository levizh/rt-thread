...
#define IS_TMR6_UNIT(x)                                     (((x) >= TMR6_INSTANCE_MIN && (x) <= TMR6_INSTANCE_MAX) && ((x) % TMR6_INSTANCE_ADDR_ALIGN) == 0U)
    ...
    #if defined (HC32F4A0) || defined (HC32F4A2) || defined (HC32F4A8) || defined (HC32F334) || defined (HC32F472)
...
#if defined (HC32F4A0) || defined (HC32F4A2) || defined (HC32F4A8) || defined (HC32F334) || defined (HC32F448) || defined (HC32F472)
