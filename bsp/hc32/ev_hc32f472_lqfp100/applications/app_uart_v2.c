...
int uart_sample(int argc, char *argv[])
{
    ...
    const char communication_mode[] = "drv_usart_v2: communication using DMA \r\n";
#elif !defined (BSP_UART1_RX_USING_DMA) && !defined (BSP_UART1_TX_USING_DMA)
    const char communication_mode[] = "drv_usart_v2: communication using interrupt \r\n";
#endif
