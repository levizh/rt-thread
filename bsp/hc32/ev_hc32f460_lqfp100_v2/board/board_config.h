...
/************************ RTC/PM *****************************/
    ...
    /***********  PWM_TIMA configure *********/
            ...
            #define PWM_TIMA_4_CH1_PORT             (GPIO_PORT_D)
            #define PWM_TIMA_4_CH1_PIN              (GPIO_PIN_12)
            #define PWM_TIMA_4_CH1_PIN_FUNC         (GPIO_FUNC_4)
        #endif
        #if defined(BSP_USING_PWM_TIMA_4_CH2)
            #define PWM_TIMA_4_CH2_PORT             (GPIO_PORT_D)
            #define PWM_TIMA_4_CH2_PIN              (GPIO_PIN_13)
            #define PWM_TIMA_4_CH2_PIN_FUNC         (GPIO_FUNC_4)
        #endif
        #if defined(BSP_USING_PWM_TIMA_4_CH3)
            #define PWM_TIMA_4_CH3_PORT             (GPIO_PORT_D)
            #define PWM_TIMA_4_CH3_PIN              (GPIO_PIN_14)
            #define PWM_TIMA_4_CH3_PIN_FUNC         (GPIO_FUNC_4)
        #endif
        #if defined(BSP_USING_PWM_TIMA_4_CH4)
            #define PWM_TIMA_4_CH4_PORT             (GPIO_PORT_D)
            #define PWM_TIMA_4_CH4_PIN              (GPIO_PIN_15)
