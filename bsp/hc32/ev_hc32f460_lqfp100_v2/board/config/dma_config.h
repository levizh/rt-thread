...
#define UART3_RX_DMA_TRANS_FLAG         DMA_FLAG_TC_CH4
...
#define UART3_TX_DMA_TRANS_FLAG         DMA_FLAG_TC_CH5
...
#define UART4_RX_DMA_CHANNEL            DMA_CH6
#define UART4_RX_DMA_CLOCK              (PWC_FCG0_DMA2 | PWC_FCG0_AOS)
#define UART4_RX_DMA_TRIG_SELECT        AOS_DMA2_6
#define UART4_RX_DMA_TRANS_FLAG         DMA_FLAG_TC_CH6
#define UART4_RX_DMA_IRQn               BSP_DMA2_CH6_IRQ_NUM
#define UART4_RX_DMA_INT_PRIO           BSP_DMA2_CH6_IRQ_PRIO
#define UART4_RX_DMA_INT_SRC            INT_SRC_DMA2_TC6
#endif
...
#define UART4_TX_DMA_TRIG_SELECT        AOS_DMA2_7
#define UART4_TX_DMA_TRANS_FLAG         DMA_FLAG_TC_CH7
#define UART4_TX_DMA_IRQn               BSP_DMA2_CH7_IRQ_NUM
#define UART4_TX_DMA_INT_PRIO           BSP_DMA2_CH7_IRQ_PRIO
#define UART4_TX_DMA_INT_SRC            INT_SRC_DMA2_TC7
#endif
